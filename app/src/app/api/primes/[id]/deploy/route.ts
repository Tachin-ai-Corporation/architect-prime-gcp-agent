 ...
 * OpenClaw config, control-daemon) is in bootstrap/prime-bootstrap.sh.
 *
...
const STARTUP_SCRIPT = [
  ...
  'SCRIPT_URL="https://raw.githubusercontent.com/${GH_OWNER}/${GH_REPO}/${CORE_REF}/bootstrap/prime-bootstrap.sh"',
