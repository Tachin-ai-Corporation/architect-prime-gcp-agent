...
import { threadKeyFor, appendTurn as ledgerAppendTurn } from '../work/thread-ledger.mjs';
import { getDwdToken as _getDwdTokenLib } from '../security/dwd-auth.mjs';
import { parseJsonResponse } from '../providers/json-repair.mjs';
import { stripArtifactFooter } from '../work/deliverable.mjs';
import { parseAddress, deliverToAddress, mirrorToDashboard, initChannel, toGChatMarkdown, discoverSpaces } from '../providers/channel.mjs';
import { composeCorrelationTag } from '../work/delegation.mjs';
...
const LLM_MODEL = MOUTH_CFG.model || 'gemini-3.6-flash';
