// platform/control-plane/projects.mjs — Project registry, validation, and dependencies
...
import { firestoreEncode, firestoreDecode } from '../persistence/firestore.mjs';
import { reconcileEntityId } from '../persistence/entity-id.mjs';
...
export function createProjectRegistry(config) {
  ...
  async function suggestContextPromotions(envelope) {
    ...
    try {
      ...
      // through the shared C-28 validator (platform/control-plane/project-context.mjs). A mission's
