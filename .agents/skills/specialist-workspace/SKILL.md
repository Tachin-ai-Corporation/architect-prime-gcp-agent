...
## Workspace Locations
- **Specialty workspaces**: `specialties/<type>/workspace/` — type-specific SOUL.md, IDENTITY.md, TOOLS.md, MEMORY.md
...
2. Add workspace files: SOUL.md, IDENTITY.md, TOOLS.md, MEMORY.md
